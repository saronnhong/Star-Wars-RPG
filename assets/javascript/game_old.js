$(document).ready(function () {
    ...
    function moveImages(character) {
        character.on("click", function () {
            ...
            if (this.id === "rey" && count === 0) {
            ...
            else if (this.id === "kylo"  && ((yourCharacter.name === vaderStats.name) || (yourCharacter.name ===bobaStats.name)) && count === 1) {          //correct alignment issue on display
                $(".imageKylo").animate({ left: "15px", top: "+=200px" }, "fast");
                $("#kyloText").animate({ left: "-10px", top: "+=200px" }, "fast");
                ...
                $(".imageKylo").animate({ left: "0px", top: "+=200px" }, "fast");
                $("#kyloText").animate({ left: "-120px", top: "+=200px" }, "fast");
                $("#paragraph").text("You have selected Kylo Ren to fight!");
                defender = kyloStats;
                console.log(defender);
            }
            else if (this.id === "boba" && (yourCharacter.name === vaderStats.name) && count === 1) {
                $(".imageBoba").animate({ left: "15px", top: "+=200px" }, "fast");
                $("#bobaText").animate({ left: "-270px", top: "+=200px" }, "fast");
